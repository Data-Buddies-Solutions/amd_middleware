...
var springHillMedicalProviders = []CheckedProvider{
	...
	{Name: "Dr. Joseph Licht", FirstName: "Joseph", LastName: "Licht", NPI: "1497147680"},
...
func medicalProviders() ([]CheckedProvider, bool) {
	office, ok := domain.LookupOfficeByID("spring_hill")
	if !ok {
		return nil, false
	}
	providers := append([]CheckedProvider(nil), springHillMedicalProviders...)
